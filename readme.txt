...
Y Ye, L Bruzzone, J Shan, F Bovolo, and Q Zhu. Fast and Robust Template Matching for Multimodal Remote Sensing Image Registration
...
------------------------- Important -------------------------
The code includes some matlab .m files and a mex file "CFOG.mexw64" , The code is only for 64-bit windows 
...
Run demo.m in MATLAB and you will see how CFOG works.
